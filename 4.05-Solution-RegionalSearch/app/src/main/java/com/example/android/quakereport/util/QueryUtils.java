...
public final class QueryUtils {
    ...
    // TODO: Add constants for the latitude, longitude, and maxradiuskm params
    private static final String PARAM_LATITUDE = "latitude";
    private static final String PARAM_LONGITUDE = "longitude";
    private static final String PARAM_MAX_RADIUS = "maxradiuskm";
    ...
    // TODO: Add a constant for the max radius
    // Use a large radius around 500--1000
    private static final String VALUE_MAX_RADIUS = "500";
    ...
    public static Map<String, String> getParamMap(Context context) {
        ...
        // TODO: Add a string specifying the region you're interested in from Utils.getRegionsMap()
        String region = context.getString(R.string.settings_region_san_francisco_key);

        // TODO: Check that the region is not R.string.settings_region_world_key
        if (!region.equals(context.getString(R.string.settings_region_world_key))) {

            // TODO: Look up the latitude and longitude from the city of your choice from Utils.getRegionsMap()
            // Also use Double.toString() to convert the latitude and longitude to strings
            HashMap<String, GeoCoordinate> regionsMap = Utils.getRegionsMap(context);
            String latitude = Double.toString(regionsMap.get(region).latitude);
            String longitude = Double.toString(regionsMap.get(region).longitude);

            // TODO: Add the latitude, longitude, and max radius parameters
            // Remember that the max radius value is a constant for now (see above)
            paramMap.put(PARAM_LATITUDE, latitude);
            paramMap.put(PARAM_LONGITUDE, longitude);
            paramMap.put(PARAM_MAX_RADIUS, VALUE_MAX_RADIUS);
        }
