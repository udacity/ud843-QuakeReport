...
public class EarthquakeActivity extends AppCompatActivity implements LoaderCallbacks<List<Earthquake>> {
    ...
    public void onLoadFinished(Loader<List<Earthquake>> loader, List<Earthquake> data) {
        if (data != null) {
            ...
            for (Earthquake earthquake : data) {
                ...
                View listItem = inflater.inflate(R.layout.earthquake_list_item, mEarthquakeLinearLayout, false);

                // TODO: Find the magnitude, location_offset, location, and date TextViews
                TextView magnitudeTextView = (TextView) listItem.findViewById(R.id.magnitude);
                ...
                dateTextView.setText(earthquake.date);
                ...
                if (earthquake.locationOffset.isEmpty()) {
                    ...
                    locationOffset.setText(getString(R.string.location_near_the));
                    ...
                    String locationOffsetString = String.format(Locale.getDefault(),
                            getString(R.string.location_of),
                ...
                mEarthquakeLinearLayout.addView(listItem);
            }
        } else {
    ...
    public void onLoaderReset(Loader<List<Earthquake>> loader) {
        ...
        mEarthquakeLinearLayout.removeAllViews();
