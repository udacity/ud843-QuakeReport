...
public class QueryUtils {
    ...
    /**
     * Return a list of {@link earthquake_data_list} objects that has been built up from
     * parsing a JSON response.
     */
    public static ArrayList<earthquake_data_list> extractEarthquakes() {

        // Create an empty ArrayList that we can start adding earthquakes to
        ArrayList<earthquake_data_list> earthquakes = new ArrayList<>();
        ...
        try {
            ...
            JSONArray earthquakeJsonFeatures = earthquakeJSON.getJSONArray("features");

            for(int i=0;i < earthquakeJsonFeatures.length();i++){
