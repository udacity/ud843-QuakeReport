...
public final class QueryUtils {
    ...
    /**
     *
     * Return a list of {@link List<Earthquake>} objects that has been built up from
     * parsing a JSON response.
     * @param jsonResponse response from USGS to be parsed.
    ...
    private static ArrayList<Earthquake> extractEarthquakes(String jsonResponse) {
        ...
        try {
            ...
            JSONObject parser = new JSONObject(jsonResponse);
