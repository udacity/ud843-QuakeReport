...
public class EarthquakeAdapter extends ArrayAdapter<Earthquake> {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        // TODO: Get the GradientDrawable that is the background of the magnitude TextView
        GradientDrawable magnitudeCircle = (GradientDrawable) viewHolder.magnitude.getBackground();

        // TODO: Convert earthquake.magnitude into a double using Double.parseDouble()
        double magnitude  = Double.parseDouble(earthquake.magnitude);

        // TODO: Set the color of the background using Utils.getMagnitudeColor()
