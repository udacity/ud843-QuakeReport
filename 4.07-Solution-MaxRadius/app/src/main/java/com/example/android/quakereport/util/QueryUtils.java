...
public final class QueryUtils {
    ...
    public static Map<String, String> getParamMap(Context context) {
        ...
        String region = sharedPrefs.getString(
                context.getString(R.string.settings_region_key),
                context.getString(R.string.settings_region_default));

        // TODO: Get the user's max radius preference
        String maxRadius = sharedPrefs.getString(
                context.getString(R.string.settings_max_radius_key),
                context.getString(R.string.settings_max_radius_default));
        ...
        if (!region.equals(context.getString(R.string.settings_region_world_key))) {
            ...
            paramMap.put(PARAM_MAX_RADIUS, maxRadius);
        }
        return paramMap;
    }
