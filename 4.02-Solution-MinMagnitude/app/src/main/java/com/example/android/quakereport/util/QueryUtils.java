...
public final class QueryUtils {
    ...
    public static Map<String, String> getParamMap(Context context) {
        ...
        // TODO: Get a reference to the system's SharedPreferences
        // Use PreferenceManager.getDefaultSharedPreferences(context)
        SharedPreferences sharedPrefs = PreferenceManager.getDefaultSharedPreferences(context);

        // TODO: Get the user's min magnitude preference using getString() on the shared preference you just got
        // The key is R.string.settings_min_magnitude_key, and the default is R.string.settings_min_magnitude_default
        // You'll need to use context.getString()
        ...
        // TODO: Put the min magnitude setting into the param map
