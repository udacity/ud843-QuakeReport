...
public final class QueryUtils {
    ...
    private static final String VALUE_MIN_MAGNITUDE = "3";
    ...
    public static List<Earthquake> extractEarthquakes(String earthquakeJSON) {
        ...
        try {
            ...
            for (int i = 0; i < featureArray.length(); i++) {
                ...
                // TODO: Use getString() to get the URL

                // TODO: Pass the URL into the earthquake constructor
